...
class Zookeeper(db.Model, SerializerMixin):
    ...
    # to stop recursive depth errors b/c of complex animals relationship
    serialize_rules = ("-animals.zookeeper",)

    # If you want to specify certain data to return when a Zookeeper
    # object is serialized. Can remove serialize_rules if using serialize_only
